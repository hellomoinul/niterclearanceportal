          ...
          <div className="border-[6px] border-double border-[#cbd5e1] rounded-2xl p-10 flex-1 flex flex-col justify-between bg-[#ffffff]">
            ...
            <div className="flex justify-between items-end px-8 mb-2">
              ...
              <div className="flex flex-col items-center justify-end">
                {isCleared && qrCodeUrl ? (
                  <img src={qrCodeUrl} alt="Verification QR Code" className="w-12 h-12 mb-2" />
                ) : (
                  <div className="w-16 h-16 mb-2 border-2 border-dashed border-[#e2e8f0] flex items-center justify-center text-[10px] text-[#64748b] text-center p-1">
                    QR Pending
                  </div>
                )}
                <div className="text-center">
              ...
              <div className="text-center flex flex-col items-center justify-end">
                {isCleared ? (
                  ...
                  <div className="h-16 mb-2 flex items-center text-xs text-[#64748b] italic">
