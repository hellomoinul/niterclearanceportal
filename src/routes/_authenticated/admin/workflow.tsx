...
export default function WorkflowConfigPage() {
  ...
  const fetchWorkflow = async () => {
    ...
    if (!error && data && data.length > 0) {
      ...
      setSteps([
        { id: '1', step_name: 'Library Dues Check', department: 'LIBRARY', step_order: 1, is_required: true, auto_approve: false },
        { id: '2', step_name: 'Accounts & Tuition Fee', department: 'ACCOUNTS', step_order: 2, is_required: true, auto_approve: false },
        { id: '3', step_name: 'Departmental Head Approval', department: 'CSE', step_order: 3, is_required: true, auto_approve: false },
        { id: '4', step_name: 'Central Registrar Sign-off', department: 'REGISTRAR', step_order: 4, is_required: true, auto_approve: false },
      ]);
    }
    setLoading(false);
  };
  ...
  const handleSaveWorkflow = async () => {
    ...
    if (!error) {
      ...
      console.log('Database sync error (mock fallback active):', error.message);
