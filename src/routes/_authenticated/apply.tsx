...
function ApplyPage() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    toast.success("Application submitted", {
      description:
        "Each office above is reviewed in order — the first office is now awaiting your documents.",
    });
      ...
      <form className="card-surface mt-8 space-y-8 p-6" onSubmit={handleSubmit}>
        ...
        <section>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            If an office genuinely does not apply to you (for example you never stayed in the
            hostel), you can mark it &ldquo;Not applicable&rdquo; from your dashboard once that
            office becomes the active step. N/A declarations are reported to the admin office for
            verification.
          </p>
        </section>
